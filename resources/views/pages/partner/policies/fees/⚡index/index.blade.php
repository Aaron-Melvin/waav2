            ...
            <tbody data-flux-rows>
                @forelse ($fees as $fee)
                    <flux:table.row :key="$fee->id">
                        <flux:table.cell variant="strong">{{ $fee->name }}</flux:table.cell>
                        <flux:table.cell>{{ $fee->type ?? 'flat' }}</flux:table.cell>
                        <flux:table.cell>{{ $fee->amount }}</flux:table.cell>
                        <flux:table.cell>{{ $fee->applies_to }}</flux:table.cell>
                        <flux:table.cell>
                        ...
                        <flux:table.cell align="end">
                            <div class="flex justify-end gap-2">
                                <flux:button size="sm" variant="ghost" wire:click="startEditing('{{ $fee->id }}')">
                                    Edit
                                </flux:button>
                                <flux:button
                                    size="sm"
