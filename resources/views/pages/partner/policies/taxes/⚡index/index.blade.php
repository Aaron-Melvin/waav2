            ...
            <tbody data-flux-rows>
                @forelse ($taxes as $tax)
                    <flux:table.row :key="$tax->id">
                        ...
                        <flux:table.cell>{{ $tax->rate }}</flux:table.cell>
                        <flux:table.cell>{{ $tax->applies_to }}</flux:table.cell>
                        <flux:table.cell>{{ $tax->is_inclusive ? 'Inclusive' : 'Exclusive' }}</flux:table.cell>
                        <flux:table.cell>
                        ...
                        <flux:table.cell align="end">
                            <div class="flex justify-end gap-2">
                                <flux:button size="sm" variant="ghost" wire:click="startEditing('{{ $tax->id }}')">
                                    Edit
                                </flux:button>
                                <flux:button
                                    size="sm"
