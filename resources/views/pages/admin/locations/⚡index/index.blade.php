                ...
                @forelse ($locations as $location)
                    <flux:table.row :key="$location->id">
                        <flux:table.cell variant="strong">
                            <flux:link href="{{ route('admin.locations.show', $location) }}" wire:navigate>
                                {{ $location->name }}
                            </flux:link>
                        </flux:table.cell>
                        <flux:table.cell>{{ $location->partner?->name }}</flux:table.cell>
                        ...
                        <flux:table.cell>{{ $location->created_at?->format('M d, Y') }}</flux:table.cell>
                    </flux:table.row>
                @empty
                    <flux:table.row>
